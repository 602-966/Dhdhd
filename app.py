...
# --- 1. SETUP & MEMORY ---
st.set_page_config(layout="wide", page_title="Omni-Elite V3.4")
...
def get_clean_data(symbol):
    try:
        ...
        # Shield 1: Catch empty API responses
        ...
        # Shield 2: Ensure the DataFrame has rows
        if df.empty: 
            return None 
        return df
    except Exception:
...
def get_ai_prediction(df, symbol):
    # Shield 3: Stop the index error from happening
...
# --- 4. MAIN INTERFACE ---
st.title("🏛️ Omni-Elite V3.4: Smart Auto-Scan")
...
with col_left:
    ...
    if data is not None and not data.empty:
        ...
        st.warning("Loading Chart Data or Market Unavailable...")
